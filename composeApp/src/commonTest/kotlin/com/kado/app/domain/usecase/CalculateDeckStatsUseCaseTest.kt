...
class CalculateDeckStatsUseCaseTest {
    ...
    fun fullIntegration_withRepository() = runTest {
        val repo = FakeDeckRepository().apply {
            ...
            cards.addAll(listOf(
                com.kado.app.domain.model.Card(id = 1, deckId = 1, front = com.kado.app.domain.model.CardContent.PlainText("a"), back = com.kado.app.domain.model.CardContent.PlainText("b")),
                com.kado.app.domain.model.Card(id = 2, deckId = 1, front = com.kado.app.domain.model.CardContent.PlainText("c"), back = com.kado.app.domain.model.CardContent.PlainText("d"))
            ))
            cardStates.addAll(listOf(
                cardState(1, queue = 0),
